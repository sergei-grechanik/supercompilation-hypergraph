...
f_deeps f_z = (case f_z of {
                 C_Nil -> (C_Nil);
                 C_Eps -> (C_Nil);
                 C_Atom f_a -> f_z;
                 C_Plus f_p f_q -> (C_Plus (f_deeps f_p) (f_deeps f_q));
                 C_Seq f_p2 f_q2 -> (case (case (f_eps f_p2) of {
                                             C_True -> (f_eps f_q2);
                                             C_False -> (C_False); }) of {
                                       C_True -> (C_Plus (f_deeps f_p2) (f_deeps f_q2));
                                       C_False -> f_z; });
                 C_Star f_p3 -> (f_deeps f_p3); });
prove: (forall f_p f_s . ((f_recognise (C_Star f_p) f_s) = (f_recognise (C_Star (f_deeps f_p)) f_s)));
