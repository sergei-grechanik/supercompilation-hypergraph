...
react = \state action -> case state of {State ser b n wS s wE e ->
	case action of {
		...
		ServG -> servG ser b n wS s wE e;
		EE1 -> ee1 ser b n wS s wE e;
		EE2 -> ee2 ser b n wS s wE e;
	};};
...
servG = \ser b n wS s wE e -> 
	case ser of {ServE -> case s of {Z -> case e of {Z ->
		State GrantE b n wS Z wE Z;
	};};};
ee1 = \ser b n wS s wE e -> 
	case ser of {ServE -> case s of {S s1 ->
		State ServE b (S n) wS s1 wE e;
	};};
ee2 = \ser b n wS s wE e -> 
	case ser of {ServE -> case e of {S e1 ->
		State ServE No (S n) wS s wE e1;
	};};
